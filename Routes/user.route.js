...
userRoutes.post('/getexam', ctrlUser.getexam);
userRoutes.post('/saveresult', ctrlUser.saveresult);
userRoutes.post('/getresult', ctrlUser.getresult);
userRoutes.post('/allexam', ctrlUser.allexam);
userRoutes.post('/addexam',ctrlUser.addexam);
